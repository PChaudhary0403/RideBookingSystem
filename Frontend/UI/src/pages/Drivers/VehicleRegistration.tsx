...
<div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh"}}>
    <div style={{width: "100%",height: "100vh",backgroundColor: "#F8FAFC"}}>
        <form onSubmit={Submit} style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100vh",gap:"5px"}}>
            ...
            <select style={{border:"2px solid #2563EB",borderRadius:"8px",padding: "10px 18px"}} value={vehicle_type} onChange={(e) => setType(e.target.value)}>
            ...
            <input style={{border:"2px solid #2563EB",borderRadius:"8px",padding: "10px 18px"}} placeholder="Company" value={parent_company} onChange={(e)=>setCompany(e.target.value)}></input>
            <input style={{border:"2px solid #2563EB",borderRadius:"8px",padding: "10px 18px"}} placeholder="Model" value={model} onChange={(e)=>setModel(e.target.value)}></input>
