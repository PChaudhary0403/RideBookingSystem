...
return(
    ...
    <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh"}}>
        <div style={{backgroundColor: "#F8FAFC"}}>
            ...
            <input style={{border:"5px solid #2563EB",borderRadius:"12px"}} placeholder="address" value={address} onChange={(e)=>setAddress(e.target.value)}/>
            <input style={{border:"5px solid #2563EB",borderRadius:"12px"}} placeholder="licenceno" value={licenceno} onChange={(e)=>setLicenseNo(e.target.value)}/>
            <input style={{border:"5px solid #2563EB",borderRadius:"12px"}} placeholder="phone" value={phone} onChange={(e)=>setPhone(e.target.value)}/>
            ...
            <input style={{border:"5px solid #2563EB",borderRadius:"12px"}} placeholder="check password" value={checkpassword} onChange={(e)=>setCheck(e.target.value)}/>
